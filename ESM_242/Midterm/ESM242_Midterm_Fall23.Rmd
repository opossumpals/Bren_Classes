...
<span style="color: blue;">**An example of a positive externality that affects the growth of neighboring stands is water filtration. If stand 2 is downstream from stand 1, the first stand plays an important role in filtering water in the water cycle and since stand 2 is downstream from stand 1, they have the benefits of cleaner water. An example of a negative externality is if there were a pest infestation that affected stand 1, with spillover effects affecting the yield of stand 2. Policy interventions that could allow the owner to internalize the positive externalities would be **.</span>
