...
```{r}
## This is the comment letter written by John Carter of the Yellowstone to Uintas Coalition for the WGFD request for comments and feedback on the Draft Elk Management Plan. 

## Read in pdf

yellowstone_uintas <- pdf_text(here("WGFD PDFs", "Copy of 4 DRAFT Feedground management plan comments J. Carter.pdf"))
